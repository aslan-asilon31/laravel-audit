...
use App\Livewire\Kriteria\Forms\KriteriaForm;
use Mary\Traits\Toast;
use Illuminate\Support\Facades\Auth;
use Spatie\Permission\Models\Permission;


class KriteriaDaftar extends Component
{

  public string $title = "Kriteria";
  public string $url = "/kriteria";
  ...
  public function headers(): array
  {
    return [
      ...
      ['key' => 'prioritas', 'label' => 'prioritas', 'sortBy' => 'prioritas', 'class' => 'whitespace-nowrap  border-1 border-l-1 border-gray-300 dark:border-gray-600 text-left'],
  ...
  public function rows(): LengthAwarePaginator
  {
    ...
    $query->when($this->search, fn($q) => $q->where('nama', 'like', "%{$this->search}%"))
      ...
      ->when(($this->filters['prioritas'] ?? ''), fn($q) => $q->where('prioritas', 'like', "%{$this->filters['prioritas']}%"))
  ...
  public function filter()
  {
    $validatedFilters = $this->validate(
      [
        ...
        'filterForm.prioritas' => 'nullable|string',
      ...
      [
        ...
        'filterForm.prioritas' => 'prioritas',
  ...
  {
    $masterData = Kriteria::findOrFail($this->id);
