...
use App\Models\TicketCategoryFirst;
...
class TicketCrud extends Component
{
  ...
  {
    return view('livewire.ticket-resources.ticket-crud')
      ->title($this->title);
  }
  ...
  #[\Livewire\Attributes\Locked]
  protected $masterModel = \App\Models\Ticket::class;

  public TicketForm $masterForm;
