...
class KriteriaPerbaharui extends Component
{

  public function render()
  {
    return view('livewire.kriteria.kriteria-perbaharui')
      ->title($this->title);
  }
  ...
  #[\Livewire\Attributes\Locked]
  private string $baseFolderName = '/files/images/kriteria';
  ...
  #[\Livewire\Attributes\Locked]
  protected $masterModel = \App\Models\Kriteria::class;

  #[\Livewire\Attributes\Locked]
  public array $optionStatus = [];

  public KriteriaForm $masterForm;
