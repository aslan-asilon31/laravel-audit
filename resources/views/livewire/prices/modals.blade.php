    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="DataModalLabel">{{ $selected_id ? 'Update Price' : 'Create Price' }}</h5>
           ...
           <div class="modal-body">
                ...
                @endif
                    ...
                    <div class="form-group">
                        ...
                        <input wire:model.live="price" type="text" class="form-control" id="price" placeholder="Price">@error('price') <span class="error text-danger">{{ $message }}</span> @enderror
                    </div>
                    <div class="form-group">
                        <label for="features"></label>
                        <input wire:model.live="features" type="text" class="form-control" id="features" placeholder="Features">@error('features') <span class="error text-danger">{{ $message }}</span> @enderror
                    </div>
