...
use App\Models\TiketBrand;
use App\Models\Tiket;
use App\Models\TiketCategoryFirst;

class TiketPerbaharui extends Component
{

  public function render()
  {
    return view('livewire.tiket-resources.tiket-crud')
      ->title($this->title);
  }
  ...
  #[\Livewire\Attributes\Locked]
  private string $baseFolderName = '/files/images/tiket';
  ...
  #[\Livewire\Attributes\Locked]
  protected $masterModel = \App\Models\Tiket::class;

  public TiketForm $masterForm;
